    ...
    public partial class initialization : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_entryfavourites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_entryfavourites_entry_EntryId",
                        column: x => x.EntryId,
                        principalSchema: "dbo",
                        principalTable: "entry",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_entryfavourites_user_CreatedById",
                        column: x => x.CreatedById,
                        principalSchema: "dbo",
                        principalTable: "user",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_entryvotes_entry_EntryId",
                        column: x => x.EntryId,
                        principalSchema: "dbo",
                        principalTable: "entry",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_entryfavourites_CreatedById",
                schema: "dbo",
                table: "entryfavourites",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_entryfavourites_EntryId",
                schema: "dbo",
                table: "entryfavourites",
                column: "EntryId");
