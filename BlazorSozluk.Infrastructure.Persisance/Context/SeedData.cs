...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    internal class SeedData
    {
        ...
        //faker bogus toolunun bir fonksiyonu
        //Bogus ile fake data oluştu
        {
            var result = new Faker<User>("tr")
                .RuleFor(i => i.Id, i=>Guid.NewGuid())
                .RuleFor(i=>i.CreatedTime, 
        ...
        {
            var dbContextBuilder = new DbContextOptionsBuilder();//yeni dbcontext oluşturacak
            ...
            var comments = new Faker<EntryComment>("tr")
                .RuleFor(i => i.Id, i => Guid.NewGuid())
                .RuleFor(i => i.CreatedTime, i => i.Date.Between(DateTime.Now.AddDays(-100), DateTime.Now))
                .RuleFor(i => i.Content, i => i.Lorem.Paragraph(2))
                .RuleFor(i => i.CreatedById, i => i.PickRandom(userIds))
